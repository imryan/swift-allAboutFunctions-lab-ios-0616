...
func problems(problems: Int) {
    print("I got \(problems) problems and Swift is all of them.")
}
/*: question6
...
favoriteBand("Grateful Dead", number: 1)
/*: question7
...
badFavoriteBand("The Beatles", position: 1)
/*: question8
...
madLib("Ryan", noun: "box", preposition: "above")
/*: question10
 ...
 */
func character(characterName: String) -> String {
